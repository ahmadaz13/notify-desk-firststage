...
Route::middleware(['auth', EnsureActiveInternalUser::class])->group(function () {
    ...
    Route::post('/payments/{payment}/allocations', [CollectionsController::class, 'allocatePayment'])->name('payments.allocations.store');
    Route::post('/payments/{payment}/auto-allocate', [CollectionsController::class, 'autoAllocatePayment'])->name('payments.auto-allocate');
    Route::post('/payment-allocations/{paymentAllocation}/reverse', [CollectionsController::class, 'reverseAllocation'])->name('payment-allocations.reverse');
    Route::post('/payments/{payment}/reverse', [CollectionsController::class, 'reversePayment'])->name('payments.reverse');
    Route::post('/payments/{payment}/refunds', [CollectionsController::class, 'refundPayment'])->name('payments.refunds.store');
    Route::post('/credit-notes/{creditNote}/applications', [CollectionsController::class, 'applyCreditNote'])->name('credit-notes.applications.store');
    Route::post('/credit-note-applications/{creditNoteApplication}/reverse', [CollectionsController::class, 'reverseCreditApplication'])->name('credit-note-applications.reverse');
    Route::post('/credit-notes/{creditNote}/void', [CollectionsController::class, 'voidCreditNote'])->name('credit-notes.void');
    Route::post('/credit-notes/{creditNote}/refunds', [CollectionsController::class, 'refundCreditNote'])->name('credit-notes.refunds.store');
    ...
    Route::post('/financial-transfers', [FinancialAccountController::class, 'storeTransfer'])->name('financial-transfers.store');
    Route::post('/financial-transfers/{financialTransfer}/reverse', [FinancialAccountController::class, 'reverseTransfer'])->name('financial-transfers.reverse');
    ...
    Route::post('/operating-expenses', [OperatingExpenseController::class, 'storeExpense'])->name('operating-expenses.store');
    Route::post('/operating-expenses/{expense}/reverse', [OperatingExpenseController::class, 'reverseExpense'])->name('operating-expenses.reverse');
    ...
    Route::post('/recurring-expense-obligations/{obligation}/pay', [OperatingExpenseController::class, 'payObligation'])->name('recurring-expense-obligations.pay');
    ...
    Route::post('/capital-funding-transactions/{transaction}/reverse', [CapitalManagementController::class, 'reverseFunding'])->name('capital-funding-transactions.reverse');
